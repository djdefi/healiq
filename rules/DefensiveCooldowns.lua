...
function DefensiveCooldowns:ShouldUseIronbark(tracker)
    ...
    elseif ironbarkReady and (BaseRule and BaseRule.IsInCombat and BaseRule:IsInCombat() and (IsInGroup() or IsInRaid())) then
...
function DefensiveCooldowns:ShouldUseBarkskin(tracker)
    ...
    local playerHealthPercent = BaseRule and BaseRule.GetHealthPercent and BaseRule:GetHealthPercent("player") or 100
