...
if not HealIQ then
    ...
    if print then print("|cFFFF0000HealIQ Error:|r OffensiveRules.lua loaded before Init.lua - addon not properly initialized") end
    return
end
...
if not Rules.BaseRule then
    if print then print("HealIQ Warning: OffensiveRules loaded before BaseRule") end
